...
import random
import glob
from academy_assistant.assistant.preprocess.Substitutions import Substitutions
...
class Preprocessing:
    ...
    def __init__(self, version='QA'):
        ...
        self.data_path = self.app_path + '/academy_assistant/assistant/data/' + self.version
