...
def get_module():
    ...
    builder.add_slide('SEAO_1', slide_text[1])
    builder.add_slide('SEAO_2', slide_text[2])
    builder.add_slide('SEAO_3', slide_text[3])
    builder.add_slide('SEAO_4', slide_text[4])
    builder.add_slide('SEAO_5', slide_text[5])
    builder.add_slide('SEAO_6', slide_text[6])
    builder.add_slide('SEAO_7', slide_text[7])
    builder.add_slide('SEAO_8', slide_text[8])
    builder.add_slide('SEAO_9', slide_text[9])
    builder.add_slide('SEAO_10', slide_text[10])
    builder.add_slide('SEAO_11', slide_text[11])
    builder.add_slide('SEAO_12', slide_text[12])
    builder.add_slide('SEAO_13', slide_text[13])
    builder.add_slide('SEAO_14', slide_text[14])
    builder.add_slide('SEAO_15', slide_text[15])
    builder.add_slide('SEAO_16', slide_text[16])
    builder.add_slide('SEAO_17', slide_text[17])
    builder.add_slide('SEAO_18', slide_text[18])
    builder.add_slide('SEAO_19', slide_text[19])
    builder.add_slide('SEAO_20', slide_text[20])
    builder.add_slide('SEAO_21', slide_text[21])
    builder.add_slide('SEAO_22', slide_text[22])
    builder.add_slide('SEAO_23', slide_text[23])
    builder.add_slide('SEAO_24', slide_text[24])
    builder.add_slide('SEAO_25', slide_text[25])
    builder.add_slide('SEAO_26', slide_text[26])
    builder.add_slide('SEAO_27', slide_text[27])
    builder.add_slide('SEAO_28', slide_text[28])
    builder.add_slide('SEAO_29', slide_text[29])
    builder.add_slide('SEAO_30', slide_text[30])
    builder.add_slide('SEAO_31', slide_text[31])
    builder.add_slide('SEAO_32', slide_text[32])

    # builder.add_slide('SEAO_33', slide_text[33])
    # builder.add_slide('SEAO_34', slide_text[34])
    # builder.add_slide('SEAO_35', slide_text[35])
    # builder.add_slide('SEAO_36', slide_text[36])
    # builder.add_slide('SEAO_37', slide_text[37])
    # builder.add_slide('SEAO_38', slide_text[38])
    # builder.add_slide('SEAO_39', slide_text[39])
    # builder.add_slide('SEAO_40', slide_text[40])
    # builder.add_slide('SEAO_41', slide_text[41])
    # builder.add_slide('SEAO_42', slide_text[42])
    # builder.add_slide('SEAO_43', slide_text[43])
    # builder.add_slide('SEAO_44', slide_text[44])
    # builder.add_slide('SEAO_45', slide_text[45])
    # builder.add_slide('SEAO_46', slide_text[46])
    # builder.add_slide('SEAO_47', slide_text[47])
    # builder.add_slide('SEAO_48', slide_text[48])
    # builder.add_slide('SEAO_49', slide_text[49])
