...
def get_module():
    ...
    builder.add_slide('SEAO_1', slide_text[1], "http://drive.google.com/uc?export=view&id=1H6DTVeY4UTOQKiFXCZxkRPhKL2emWPHB")
    builder.add_slide('SEAO_2', slide_text[2], "http://drive.google.com/uc?export=view&id=1AS2Wp6TRwZMNiXOT2PyvvEBXKX5ymsm2")
    builder.add_slide('SEAO_3', slide_text[3], "http://drive.google.com/uc?export=view&id=1EvAhnBJCvkc-exO-c54NLn3PUuuXG1W0")
    builder.add_slide('SEAO_4', slide_text[4], "http://drive.google.com/uc?export=view&id=1zinYrbyCjM_bqBso0EzUZXRDNuKy8XLe")
    builder.add_slide('SEAO_5', slide_text[5], "http://drive.google.com/uc?export=view&id=1NgaY2v9jzmcWZ91lc7Zmk34Bm2fTDIqv")
    builder.add_slide('SEAO_6', slide_text[6], "http://drive.google.com/uc?export=view&id=1FmUt9sXuSocsf9G5HU8wDPIiwVBjZER4")
    builder.add_slide('SEAO_7', slide_text[7], "http://drive.google.com/uc?export=view&id=1IQ3Co-8yJ9EYmbCAPrpnwk2OzvAqg_br")
    builder.add_slide('SEAO_8', slide_text[8], "http://drive.google.com/uc?export=view&id=1qlQ58gGxDSMm7lSAkgstoTg1r7xFU_f7")
    builder.add_slide('SEAO_9', slide_text[9], "http://drive.google.com/uc?export=view&id=1mdpEjFWhqV20UELwV0-QMp1vQX9y1ykT")
    builder.add_slide('SEAO_10', slide_text[10], "http://drive.google.com/uc?export=view&id=1bTM5C97UV1DJtpg3IshwNr8Qu4bce4rM")
    builder.add_slide('SEAO_11', slide_text[11], "http://drive.google.com/uc?export=view&id=1Y0WJ9cyZiA6vzDYGTS6s85NPTmEeqiwX")
    builder.add_slide('SEAO_12', slide_text[12], "http://drive.google.com/uc?export=view&id=1f1gjo874iOJ3o-els5dSUnUsB1egcfvC")
    builder.add_slide('SEAO_13', slide_text[13], "http://drive.google.com/uc?export=view&id=12Z-HlMTUsb_nrX96epr0L2r-ej_DFF01")
    builder.add_slide('SEAO_14', slide_text[14], "http://drive.google.com/uc?export=view&id=1v3gQb_8324bvFVdOyOOr1HiyUDVv1HwE")
    builder.add_slide('SEAO_15', slide_text[15], "http://drive.google.com/uc?export=view&id=1IUmAMC7FbVzel0bUVekyisrSNHenYrMI")
    builder.add_slide('SEAO_16', slide_text[16], "http://drive.google.com/uc?export=view&id=1sjlJCNDkwptYVELJNz0mrtCGvb1ZLp3Y")
    builder.add_slide('SEAO_17', slide_text[17], "http://drive.google.com/uc?export=view&id=1Zk38pwTKnTmt74pnp5J1S9URUHdKGAkh")
    builder.add_slide('SEAO_18', slide_text[18], "http://drive.google.com/uc?export=view&id=1UYwqdxM5gCIa2vvvo-WcHjd6ukW-dT-i")
    builder.add_slide('SEAO_19', slide_text[19], "http://drive.google.com/uc?export=view&id=1lfvu4rdwboPb5OK9wKslDVNUjy4wWQMj")
    builder.add_slide('SEAO_20', slide_text[20], "http://drive.google.com/uc?export=view&id=1qZuqow8bwb2uaFE-nUI-QB9mTbWIT91i")
    builder.add_slide('SEAO_21', slide_text[21], "http://drive.google.com/uc?export=view&id=1WIG78yqlN-AwCg1aGX3Zkmf1sPnEyVra")
    builder.add_slide('SEAO_22', slide_text[22], "http://drive.google.com/uc?export=view&id=1gEAzeWt7Y6khuYzMOUkGm_2N_4xuDdGj")
    builder.add_slide('SEAO_23', slide_text[23], "http://drive.google.com/uc?export=view&id=11t8HOnvz5ZJJ_8hjJMFuGZxYb0e1HUhE")
    builder.add_slide('SEAO_24', slide_text[24], "http://drive.google.com/uc?export=view&id=1fn8axzFT0lImMvS1L0rF6VBZnJ8u_cDh")
    builder.add_slide('SEAO_25', slide_text[25], "http://drive.google.com/uc?export=view&id=1WbbRxFI0kyHvMWJ2Hl0fhDY1i8kx-vt8")
    builder.add_slide('SEAO_26', slide_text[26], "http://drive.google.com/uc?export=view&id=1jD7uP47bdiCijecnGmy7xgHEXPwPFO8b")
    builder.add_slide('SEAO_27', slide_text[27], "http://drive.google.com/uc?export=view&id=1oVYIZIDF9agylneHBpSN5T_H-jzVdTlt")
    builder.add_slide('SEAO_28', slide_text[28], "http://drive.google.com/uc?export=view&id=1Bg2kTEpSzu8pQ6MIZdXKtfIPbg40bz6W")
    builder.add_slide('SEAO_29', slide_text[29], "http://drive.google.com/uc?export=view&id=125K4j_adMwlhmGnWnvF-smRF0rs3ng7i")
    builder.add_slide('SEAO_30', slide_text[30], "http://drive.google.com/uc?export=view&id=1eSr2uDswHHlX83kNvUVIk73mRRaisTwh")
    builder.add_slide('SEAO_31', slide_text[31], "http://drive.google.com/uc?export=view&id=1RoYt0txIHuvWtOlKghqrP4N93P1YJCPW")
    builder.add_slide('SEAO_32', slide_text[32], "http://drive.google.com/uc?export=view&id=1z5IL8HIWm0a8kJCQyTMhoPWCw-i4wh9R")

    # builder.add_slide('SEAO_33', slide_text[33], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_34', slide_text[34], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_35', slide_text[35], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_36', slide_text[36], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_37', slide_text[37], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_38', slide_text[38], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_39', slide_text[39], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_40', slide_text[40], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_41', slide_text[41], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_42', slide_text[42], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_43', slide_text[43], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_44', slide_text[44], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_45', slide_text[45], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_46', slide_text[46], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_47', slide_text[47], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_48', slide_text[48], "http://drive.google.com/uc?export=view&id=")
    # builder.add_slide('SEAO_49', slide_text[49], "http://drive.google.com/uc?export=view&id=")
