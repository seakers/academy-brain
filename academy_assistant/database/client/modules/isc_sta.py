...
slide_text = ['']
import os
# slide_text_dir = os.path.join('/Users/mahima/Documents/daphne-academy/academy-brain/academy_assistant/database/client/modules/slide_text', 'sta')
base_dir = os.path.dirname(os.path.abspath(__file__))
slide_text_dir = os.path.join(base_dir, 'slide_text', 'sta')
