...
def get_module():
    ...
    builder.add_mc_question(
        ...
        [
            {'text': 'A. Active instruments are on all the time, passive instruments are only on part of the time',
             'correct': False, 'id': 0},
            {'text': 'B. Passive instruments emit no electromagnetic radiation, while active instruments do',
             'correct': True, 'id': 1},
            {'text': 'C. Active instruments will gimbal themselves to a target, passive ones will not',
             'correct': False, 'id': 2},
