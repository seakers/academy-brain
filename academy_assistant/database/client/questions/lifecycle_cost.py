from academy_assistant.database.client.questions.QuestionBuilder import QuestionBuilder
...
def get_questions():
    return [
        ...
        ### SLIDE 1 ###
        ###############
        QuestionBuilder(['Intro To Space'], easy_question)  # easy
        .set_text(
        ...
        # QuestionBuilder(['Intro To Space'])  # medium
        # .set_text(
        ...
        QuestionBuilder(['Intro To Space'], hard_question)  # hard
        .set_text(
        ...
        QuestionBuilder(['Intro To Space'], medi_question)  # medium
        .set_text(
        ...
        # .build_tf_question(True),
        QuestionBuilder(['Intro To Space'])  # hard
